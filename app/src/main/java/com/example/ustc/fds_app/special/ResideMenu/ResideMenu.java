package com.example.ustc.fds_app.special.ResideMenu;
...
import com.example.ustc.fds_app.nineoldandroids.animation.Animator;
import com.example.ustc.fds_app.nineoldandroids.animation.AnimatorSet;
import com.example.ustc.fds_app.nineoldandroids.animation.ObjectAnimator;
import com.example.ustc.fds_app.nineoldandroids.view.ViewHelper;
...
public class ResideMenu extends FrameLayout {
	 ...
	 * @param direction
	 */
    //this.leftMenuItems.add(menuItem);可以删掉并没有用到
